...
internal class CustomRoleSelector
{
    ...
    EndOfAssign:
        ...
        {
            if (rd.Next(0, 100) < 80 && rolesToAssign.Remove(CustomRoles.Jester)) rolesToAssign.Add(CustomRoles.Sunnyboy);
            if (rd.Next(0, 100) < 80 && rolesToAssign.Remove(CustomRoles.Sans)) rolesToAssign.Add(CustomRoles.Bard);
