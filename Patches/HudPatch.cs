...
class VentButtonDoClickPatch
{
    public static bool Prefix(VentButton __instance)
    {
        ...
        if (pc.GetCustomRole() is CustomRoles.Swooper or CustomRoles.Arsonist or CustomRoles.Revolutionist or CustomRoles.Veteran or CustomRoles.Paranoia or CustomRoles.Mayor or CustomRoles.Grenadier or CustomRoles.DovesOfNeace or CustomRoles.Rudepeople)
        {
